...
$(document).ready(function () {
    ...
    (function ($) {
        ...
        // On carousel scroll
        $(document).on('slide.bs.carousel','#customerCarousel', function (e) {
...
$(document).ready(function () {
    ...
    $(document).on('click touchstart','ul.nav-tabs.whyus-tabs li a', function (e) {
